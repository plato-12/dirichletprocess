...
if (file.exists("R/mvnormal_normal_wishart.R")) {
  cat("Loading development version...")
  devtools::load_all()
  cat(" ✓ Done\n")
} else {
...
```
## Using installed package version
```
...
```
##   Data points per cluster: 1, 1, 6, 7, 6, 15, 6, 2, 1, 1, 1, 4, 4, 5, 1, 5, 1, 2, 3, 4, 11, 1, 2, 1, 12, 2, 1, 5, 6, 2, 5, 1, 1, 2, 3, 2, 2, 2, 1, 3, 2, 1, 1, 2, 1, 1, 1
```
...
```
##   Data points per cluster: 1, 6, 1, 12, 7, 3, 2, 3, 2, 13, 1, 1, 6, 6, 3, 1, 1, 3, 2, 5, 8, 1, 1, 2, 11, 4, 7, 1, 1, 4, 1, 4, 1, 1, 2, 3, 3, 1, 3, 5, 3, 1, 1, 1, 1
```
...
```
##   Data points per cluster: 5, 6, 12, 6, 4, 3, 1, 3, 1, 8, 1, 1, 11, 2, 2, 12, 4, 14, 3, 4, 10, 3, 3, 1, 2, 5, 12, 2, 2, 1, 1, 1, 1, 1, 1, 1
```
...
```
##   Data points per cluster: 1, 5, 3, 29, 2, 2, 1, 1, 2, 21, 8, 4, 8, 8, 2, 3, 7, 5, 2, 20, 2, 2, 1, 1, 2, 1, 1, 3, 1, 1, 1
```
...
```
##   Data points per cluster: 4, 2, 2, 1, 1, 2, 1, 2, 4, 11, 4, 1, 1, 2, 2, 9, 1, 4, 1, 1, 1, 9, 1, 5, 2, 1, 10, 2, 2, 1, 1, 4, 5, 3, 1, 8, 2, 3, 4, 5, 1, 4, 5, 1, 1, 1, 1, 2, 2, 1, 1, 1, 1, 1, 1
```
...
```
##   Data points per cluster: 10, 3, 2, 9, 22, 5, 8, 12, 49, 16, 1, 4, 4, 1, 1, 2, 1
```
...
```
##   Data points per cluster: 3, 1, 3, 9, 6, 3, 12, 5, 4, 1, 12, 15, 12, 2, 2, 2, 1, 1, 4, 3, 4, 2, 2, 1, 4, 1, 1, 3, 2, 1, 1, 2, 1, 1, 2, 2, 2, 1, 1, 4, 6, 1, 2, 1, 1
```
...
```
##   Mean time per model: 12.86 seconds
```
...
```
##   Median time per model: 19.01 seconds
```
...
```
##   Fastest model overall: EII ( 2.56 sec )
```
...
```
##   Slowest model overall: FULL ( 22.69 sec )
```

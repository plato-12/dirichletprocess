# Diagnostic script for E model initialization issue
# This script tests each step of E model initialization to identify the exact failure point

library(dirichletprocess)

# Enable C++ mode for testing
set_use_cpp(TRUE)

# Test function to analyze E model initialization
test_e_model_initialization <- function() {
  cat("=== E Model Initialization Diagnostic ===\n")
